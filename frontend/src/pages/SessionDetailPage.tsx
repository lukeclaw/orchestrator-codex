      ...
      <div className={`fe-content-area ${fe.open ? 'fe-content-area--open' : ''}`}>
        ...
        <div className="fe-right-pane">
          ...
          <div className="sd-terminal-area">
            ...
            <TerminalView sessionId={session.id} sessionStatus={session.status} reconnectStep={session.reconnect_step} onFocusRef={(fn) => { terminalFocusRef.current = fn }} onImagePaste={handleImagePaste} onTextPaste={handleTextPaste} onFileDrop={handleFileDrop} onPastingChange={setCtxPasting} onReconnect={handleReconnect} />
          </div>
